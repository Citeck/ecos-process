...
import ru.citeck.ecos.process.domain.cmmn.model.DiagramElement
...
import ru.citeck.ecos.process.domain.ecmmn.io.convert.artifact.TextAnnotationConverter
import ru.citeck.ecos.process.domain.ecmmn.io.convert.di.CmmnDiConverter
import ru.citeck.ecos.process.domain.ecmmn.io.convert.di.EdgeConverter
import ru.citeck.ecos.process.domain.ecmmn.io.convert.di.ShapeConverter
...
import ru.citeck.ecos.process.domain.ecmmn.io.convert.plan.*
...
class CmmnConverters(
    ...
    companion object {
        private val PROP_TYPE = QName(CmmnUtils.NS_ECOS, "cmmnType")
    }
