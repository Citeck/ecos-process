...
val BPMN_PROP_NOTIFICATION_FROM = QName(NS_ECOS, "notificationFrom")
...
val BPMN_PROP_DUE_DATE = QName(NS_ECOS, "dueDate")
val BPMN_PROP_FOLLOW_UP_DATE = QName(NS_ECOS, "followUpDate")
