...
val BPMN_PROP_WORKSPACE = QName(NS_ECOS_BPMN, "workspace")
...
val BPMN_PROP_NOTIFICATION_CALENDAR_EVENT_ORGANIZER_EXPRESSION = QName(NS_ECOS_BPMN, "notificationCalendarEventOrganizerExpression")
val BPMN_PROP_NOTIFICATION_CALENDAR_EVENT_DATE = QName(NS_ECOS_BPMN, "notificationCalendarEventDate")
val BPMN_PROP_NOTIFICATION_CALENDAR_EVENT_DATE_EXPRESSION = QName(NS_ECOS_BPMN, "notificationCalendarEventDateExpression")
val BPMN_PROP_NOTIFICATION_CALENDAR_EVENT_DURATION = QName(NS_ECOS_BPMN, "notificationCalendarEventDuration")
val BPMN_PROP_NOTIFICATION_CALENDAR_EVENT_DURATION_EXPRESSION = QName(NS_ECOS_BPMN, "notificationCalendarEventDurationExpression")
...
val BPMN_PROP_AI_USER_INPUT = QName(NS_ECOS_BPMN, "aiUserInput")
val BPMN_PROP_AI_PREPROCESSING_SCRIPT = QName(NS_ECOS_BPMN, "aiPreprocessingScript")
val BPMN_PROP_AI_POSTPROCESSING_SCRIPT = QName(NS_ECOS_BPMN, "aiPostprocessingScript")
val BPMN_PROP_AI_ADD_DOCUMENT_TO_CONTEXT = QName(NS_ECOS_BPMN, "aiAddDocumentToContext")
val BPMN_PROP_AI_SAVE_RESULT_TO_DOCUMENT_ATT = QName(NS_ECOS_BPMN, "aiSaveResultToDocument")
val BPMN_PROP_AI_AGENT_REF = QName(NS_ECOS_BPMN, "aiAgentRef")
