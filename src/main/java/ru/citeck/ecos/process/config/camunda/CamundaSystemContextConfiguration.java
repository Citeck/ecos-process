...
import ru.citeck.ecos.process.domain.bpmn.engine.camunda.interceptors.ExecuteJobAsSystemInterceptor;
import ru.citeck.ecos.process.domain.bpmn.engine.camunda.interceptors.InvokeScriptAsSystemDelegateInterceptor;
