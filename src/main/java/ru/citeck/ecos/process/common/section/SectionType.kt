...
enum class SectionType(
    ...
    BPMN("bpmn-section", BpmnPermission.SECTION_EDIT_PROC_DEF.id, BpmnPermission.PROC_DEF_DEPLOY.id),
    DMN("dmn-section", DmnPermission.SECTION_EDIT_DMN_DEF.id, DmnPermission.DMN_DEF_DEPLOY.id);
