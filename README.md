...
Welcome to the Citeck `ecos-process` repository! This repository contains the process definitions and workflows for the Citeck platform. Citeck is a powerful and comprehensive enterprise content and operations system designed to streamline and automate business processes within organizations.
